...
public class GameOptions {
	 ...
	 */
	public GameOptions(GameController gameLogic) {
	...
	public boolean createPlayers() {
		...
		for(PlayerTemp playerTemp : playersTemp) {
			if(playerTemp.active) {
				Player player = playerTemp.isAi ? new PlayerAI(playerTemp.name, playerTemp.team - 1) : new Player(playerTemp.name, playerTemp.team - 1);
